...
hidden if the `sts_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sts_DEVELOPER_MODE` to the configure
...
Runs the executable target `sts_exe`.
